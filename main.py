...
def run():
    ...
    #AI's functions (Collapse if needed):
    ...
    #TranslateLangaugeEnum (PromptTypeEnum? NOT SURE):
        ...
        async def translate(interaction: discord.Interaction, *, language: str, context: str):
            ...
            try:
                ...
                error_message = "❌ Error: The language can only be: English, Korean, Chinese, Japanese, Spanish, Russian, French, German, Italian, Portuguese, Dutch, Indonesian, Tagalog or Vietnamese."
    ...
    @client.tree.command(name="continue_writing", description="Continue writing, generating more")
    ...
    #ToneEnum (is also part of PromptTypeEnum):
    ...
    async def change_tone(interaction: discord.Interaction, *, context: str, tone: str):
        ...
        try:
            ...
            error_message = "❌ Error: The Tone Has To Be Either Professional, Casual, Straightforward, Confident, or Friendly."
            await sender.send_message(interaction, send_message, error_message)
